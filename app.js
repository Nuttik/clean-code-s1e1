...
var createNewTaskElement = function(taskString){
    ...
    listItem.classList.add("task"); //добавляю класс BEM

    //input (checkbox)
    var checkBox = document.createElement("input");//checkbox
    checkBox.classList.add("task__checkbox"); //добавляю класс BEM

    //label
    var label = document.createElement("label");//label
    label.classList.add("task__label"); //добавляю класс BEM

    //input (text)
    var editInput = document.createElement("input");//text
    editInput.classList.add("task__input", "task__input_disable"); //добавляю класс BEM

    //button.edit
    var editButton=document.createElement("button");//edit button
    editButton.classList.add("button","button_edit"); //добавляю класс BEM

    //button.delete
    var deleteButton = document.createElement("button");//delete button
    deleteButton.classList.add("button","button_delete"); //добавляю класс BEM

    var deleteButtonImg = document.createElement("img");//delete button image
    deleteButtonImg.classList.add("button__img"); //добавляю класс BEM
...
//убираю дублирование события по клику addButton.onclick=addTask;
